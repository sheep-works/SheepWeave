...
export async function mqxliff2Pairs(content: string, startIdx: number): Promise<TranslationPair[]> {
    const data = await parseStringPromise(content) as MqxliffJsTopSchema;
