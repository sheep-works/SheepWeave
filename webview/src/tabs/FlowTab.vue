          ...
          <a-list>
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'open-current')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'archive-previous')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
            <a-list-item>
            ...
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'convert-to-shwv')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
          </a-list>
          ...
          <a-list>
            ...
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'reanalyze')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
          </a-list>
          ...
          <a-list>
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'export-xliff')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
            <a-list-item>
              <a-space>
                ...
                <a-button @click="$emit('FlowCommand', 'merge-to-final')">{{ i18nStore.getText('flowTab', 'btnText')
                }}</a-button>
              </a-space>
            </a-list-item>
            <a-list-item>
