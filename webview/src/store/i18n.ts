    ...
    state: () => ({
        ...
        tabs: {
            ...
            llmTab: {
                ...
                runTabTitle: { en: "Run & Results", ja: "実行と結果", zh: "运行与结果" },
                ...
                batchRunTooltip: { en: "Automatically process unconfirmed segments with AI", ja: "未確定の行をAIで一括翻訳します", zh: "使用 AI 自动处理未确认的分句" },
                ...
                noResponseYet: { en: "No response yet. Run check or batch process to view results here.", ja: "応答はまだありません。実行または一括処理を行うと結果が表示されます。", zh: "尚无响应。运行检测或批量处理以在此查看结果。" },
                outputKeysCard: { en: "Output Keys (JSONL Schema)", ja: "出力キー指定 (JSONL Schema)", zh: "输出键指定 (JSONL Schema)" },
                schemaIdxNote: { en: "Note: idx is always included.", ja: "※ idx は常に自動で含まれます。", zh: "注意：idx 总是包含在内。" },
